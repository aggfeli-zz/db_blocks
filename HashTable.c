...
HT_info* HT_OpenIndex(char *fileName) {
    ...
    memcpy(&(headerInfo->numBuckets), block + sizeof("Hashtable") + sizeof(char*) + sizeof(char) + sizeof(int), sizeof(int));
...
void initializeMetadataBlock(HT_info* headerInfo) {
    ...
    memcpy(block + sizeof("Hashtable") + sizeof(char) + sizeof(char *) + sizeof(int), &headerInfo->numBuckets, sizeof(int));
